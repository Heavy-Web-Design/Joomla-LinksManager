<?php
/**
 * Class for displaying the Ordering field in the link edit layout
 */
...
class JFormFieldLinkOrdering extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$options = array_merge(
			array(array('value' => '-1', 'text' => JText::_('COM_HWDLINKS_ITEM_FIELD_ORDERING_VALUE_FIRST'))),
			$options,
			array(array('value' => '-2', 'text' => JText::_('COM_HWDLINKS_ITEM_FIELD_ORDERING_VALUE_LAST')))
		);
	...
	protected function getInput()
	{
		...
		{
			return '<span class="readonly">' . JText::_('COM_HWDLINKS_ITEM_FIELD_ORDERING_TEXT') . '</span>';
		}
		else
		{
