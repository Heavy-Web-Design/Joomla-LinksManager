...
/**
 * Script file of HwdLinks component.
 *
 ...
 */
class com_hwdLinksInstallerScript
{
    /**
    ...
    {
        echo '<p>' . JText::_('COM_HWDLINKS_UNINSTALL_TEXT') . '</p>';
    }
    ...
    {
        echo '<p>' . JText::sprintf('COM_HWDLINKS_UPDATE_TEXT', $parent->get('manifest')->version) . '</p>';
    }
    ...
    $columns = array('id','title', 'published', 'parent_id','rgt');
		//$values = array(1, 'hwdlinks root','hwdlinks-root-alias',0, 2 * (int)$total + 1);
    $values = array(1, 'links root', 1, 0, 2 * (int)$total + 1);
